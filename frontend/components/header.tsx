...
export function Header() {
  ...
  const displayName = session?.user?.name?.trim() || "Teacher";
        ...
        <div className="ml-auto flex items-center gap-4">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={() => alert("English selected")}>
                English
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() => alert("中文 (Chinese) selected")}
              >
                中文 (Chinese)
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() => alert("Español (Spanish) selected")}
              >
                Español (Spanish)
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() => alert("Français (French) selected")}
              >
                Français (French)
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() => alert("日本語 (Japanese) selected")}
              >
                日本語 (Japanese)
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() => alert("한국어 (Korean) selected")}
              >
                한국어 (Korean)
              </DropdownMenuItem>
            </DropdownMenuContent>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56" align="end" forceMount>
              ...
              <DropdownMenuItem asChild>
                <Link
                  href="/dashboard/teacher/profile?tab=profile"
